...
#   Description: shadowsocks one key install server for CentOS      #
...
libsodium_url='https://i.inetpub.cn/linux/libsodium-1.0.18.tar.gz'

mbedtls_file='mbedtls-2.16.12'
mbedtls_url='https://i.inetpub.cn/linux/mbedtls-2.16.12.tar.gz'
...
get_latest_version(){
    ...
    download_link="https://i.inetpub.cn/linux/shadowsocks-libev-3.3.5.tar.gz"
...
print_info(){
    clear
    echo "# shadowsocks one key install server for CentOS #"
    echo
}
...
install_shadowsocks(){
    ...
    echo
    echo "https://github.com/Drliehuo/shadowsocks"
    echo "Enjoy it!"
    echo
}
